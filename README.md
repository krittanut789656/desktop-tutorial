...
โครงการนี้แบ่งการวิเคราะห์ออกเป็น 7 ส่วน เพื่อศึกษาปัจจัยที่มีผลต่ออุตสาหกรรมพลังงานและนำไปสู่กรอบการลงทุนเชิงกลยุทธ์<br>
...
ในช่วง 26ปีที่ผ่านมา(ม.ค.2000 – มี.ค.2026) ภาคพลังงานเผชิญกับแรงกดดันรอบด้าน ตั้งแต่วิกฤตการเงินโลก(Global Financial Crisis) การปฏิวัติ Shale Oil ในสหรัฐฯ การแพร่ระบาดของ COVID-19ไปจนถึงสงครามรัสเซีย-ยูเครนและวิกฤตอิหร่าน แต่ในขณะเดียวกันนั้นหุ้นพลังงานหลายตัวกลับสร้างผลตอบแทนสะสมที่สูงกว่าดัชนีตลาดทั่วไปโดยเฉพาะในช่วงที่เงินเฟ้อพุ่งสูงและเกิดความขัดแย้งด้านภูมิรัฐศาสตร์ 

ความขัดแย้งนี้ชี้ให้เห็นว่าหุ้นพลังงานไม่ใช่สินทรัพย์ที่ "ซื้อแล้วลืม" ได้ แต่เป็นสินทรัพย์ที่ต้องอาศัยความเข้าใจอย่างลึกซึ้งในหลายมิติ ทั้งด้านโครงสร้างตลาด ตัวแปรมหภาค พฤติกรรมในช่วงวิกฤต และประสิทธิภาพเชิงเปรียบเทียบ จึงจะสามารถออกแบบกลยุทธ์การจัดสรรการลงทุนที่เหมาะสมได้

### คำถามวิจัย (Research Questions)
การศึกษานี้ตั้งคำถามหลัก 5 ข้อ ซึ่งแต่ละข้อจะถูกตอบด้วยการวิเคราะห์เชิงปริมาณ (Quantitative Analysis)
- **RQ1**: สินทรัพย์พลังงานมีโครงสร้างความสัมพันธ์อย่างไร และการกระจายความเสี่ยงข้ามประเทศ (US vs Thai) ให้ประโยชน์จริงหรือไม่?
- **RQ2**: ตัวแปรมหภาคตัวใดมีอิทธิพลสำคัญต่อผลตอบแทนหุ้นพลังงาน และหุ้นพลังงานสามารถเป็นเกราะป้องกันเงินเฟ้อได้จริงหรือไม่?
- **RQ3**: วิกฤตแต่ละประเภท (Supply Shock, Demand Shock, Systemic Crisis) ส่งผลต่อความผันผวนของหุ้นพลังงานแตกต่างกันอย่างไร?
- **RQ4**: ในช่วงวิกฤตจริง หุ้นพลังงานสหรัฐฯ กับไทยตัวใดให้ผลตอบแทนดีกว่า ฟื้นตัวเร็วกว่า และเสียหายน้อยกว่า?
- **RQ5**: ข้อค้นพบทั้งหมดสามารถสังเคราะห์เป็นกรอบกลยุทธ์การจัดสรรการลงทุน (Strategic Allocation Framework) ที่ปฏิบัติได้จริงหรือไม่?

### ขอบเขตและวิธีการศึกษา (Scope and Methodology)
- **ขอบเขตเวลา**: มกราคม 2000 – มีนาคม 2026 (26 ปี, ข้อมูลรายสัปดาห์)
- **สินทรัพย์ที่ศึกษา**: หุ้นพลังงานสหรัฐฯ 5 ตัว, หุ้นพลังงานไทย 5 ตัว, น้ำมันดิบ 2 สัญญา(รายละเอียดในส่วนถัดไป)
- **ตัวแปรเศรษฐกิจมหภาค**: ดัชนีเงินเฟ้อ (CPI), ดัชนีค่าเงินดอลลาร์ (USD Index), ดัชนีผลผลิตอุตสาหกรรม (INDPRO), ดัชนีความผันผวน (VIX)
- **แหล่งข้อมูล**: Yahoo Finance (ราคาหุ้นและสินค้าโภคภัณฑ์) และ Federal Reserve Economic Data หรือ FRED (ข้อมูลมหภาค)
...
Correlation Matrix ที่คำนวณจาก Weekly Returns ตลอด 26 ปี เผยให้เห็นโครงสร้างความสัมพันธ์ที่สำคัญ 3 ประการ</br>

1. หุ้นพลังงานสหรัฐฯ (XOM, CVX, COP) มี Intra-group Correlation สูงมาก (r > 0.7) แสดงว่าหุ้นกลุ่มนี้เคลื่อนไหวเป็นกลุ่มก้อน (Cluster) การถือหุ้น US Energy หลายตัวพร้อมกันจึงไม่ได้ให้ Diversification Benefit ที่แท้จริง</br>
2. Correlation ระหว่างกลุ่ม US กับกลุ่ม Thai อยู่ที่ระดับปานกลาง (~0.45) ซึ่งเกิดจากความแตกต่างด้านโครงสร้างตลาดทุน อัตราแลกเปลี่ยน นโยบายการควบคุมราคาภายในประเทศ และสัดส่วนธุรกิจ Upstream-Downstream ที่ต่างกัน ความแตกต่างนี้ชี้ให้เห็นว่าการจัดสรรข้ามประเทศ (Cross-country Allocation) ให้ประโยชน์ด้านการกระจายความเสี่ยงได้ดีกว่าการจัดสรรภายในประเทศเดียว</br>
3. Brent Crude ทำหน้าที่เป็น Central Node ที่มี Correlation บวกกับทุกสินทรัพย์ในระบบ แสดงว่าราคาน้ำมันคือตัวแปรหลัก (Dominant Factor) ที่ขับเคลื่อนทั้งระบบ อย่างไรก็ตาม ค่า Correlation ไม่คงที่ตลอดเวลา — งานวิจัยด้าน Dynamic Conditional Correlation (DCC) ชี้ว่า Correlation มักพุ่งสูงขึ้นในช่วงวิกฤต ซึ่งเป็นช่วงที่ Diversification Benefit ลดลงพอดี
...
**Key Findings:**
- หุ้นพลังงานยืนยันคุณสมบัติ Inflation Hedge ด้วย Real Return เป็นบวกในระยะยาว
...
ในวิกฤต Great RecessionThailand ฟื้นตัวได้รวดเร็วและแข็งแกร่งกว่า US อย่างมีนัยสำคัญ โดยภายใน 30 สัปดาห์ดัชนีของไทยพุ่งขึ้นเกือบแตะระดับ 200 (โตขึ้น 100%) ในขณะที่ US ยังทรงตัวอยู่ที่ระดับ 120-130 เท่านั้น COVID-19 ทั้งสองตลาดฟื้นตัวในรูปแบบ V-Shape เหมือนกัน แต่ในช่วง 10 สัปดาห์แรก US ฟื้นตัวได้แรงกว่า ก่อนจะเริ่มชะลอตัวและเคลื่อนไหวในทิศทางใกล้เคียงกับไทยในช่วงสัปดาห์ที่ 20-30 Russia-Ukraine War ตลาด US แสดงการฟื้นตัวที่ชัดเจนกว่าไทย โดยสามารถทำ New High เหนือระดับก่อนวิกฤตได้เร็วกว่า ในขณะที่ไทยยังเป็นการฟื้นตัวแบบค่อยเป็นค่อยไป (L-Shape หรือ U-Shape อ่อนๆ)

**Key Findings:**
- ความแตกต่างตามภูมิภาคไม่สามารถสรุปได้ว่าตลาดใดดีกว่าในทุกวิกฤต (No one-size-fits-all) ไทยเด่นมากในยุค Great Recession ส่วน US ทำได้ดีกว่าในช่วงความขัดแย้งทางภูมิรัฐศาสตร์ล่าสุด
...
<img width="2385" height="1035" alt="16_wealth_creation" src="https://github.com/user-attachments/assets/2c309cd5-ea27-4d4a-8ad8-14e70ff9ed05" />
...
### Fig 17. Sharpe Ratio Heatmap — ผลตอบแทนเทียบกับความเสี่ยง' ของหุ้นพลังงานโลกและหุ้นไทย ใน 6 ช่วงวิกฤต 
...
**ยุคทองและยุคตกต่ำ (Pre-Crisis Boom & Great Recession)**
: หุ้นพลังงานโลก (XOM, CVX) และหุ้นไทย (PTT.BK) เคยเป็นซูเปอร์สตาร์ให้ผลตอบแทนคุ้มค่าสุด ๆ ช่วงวิกฤตเศรษฐกิจโลก: หุ้นทุกตัว "ติดลบ" เกือบหมด (สีส้ม) หมายความว่าในช่วงที่เศรษฐกิจพัง ความต้องการใช้น้ำมันลดลงหุ้นกลุ่มนี้จึงไม่น่าลงทุนอย่างยิ่ง

**ยุค COVID-19 ถึง สงครามรัสเซีย-ยูเครน**
COVID-19: เป็นช่วงที่หุ้นกลุ่มนี้ "ย่ำแย่" เพราะคนหยุดเดินทางแต่ที่น่าสนใจคือหุ้นไทยบางตัวอย่าง PTTGC.BK กลับรอดมาได้ (ค่า 0.30) เพราะอาจได้อานิสงส์จากธุรกิจปิโตรเคมีที่นำไปทำบรรจุภัณฑ์หรืออุปกรณ์การแพทย์ สงครามรัสเซีย-ยูเครน: หุ้นพลังงานโลก (XOM, CVX, COP) เริ่มกลับมาเป็นบวกเพราะราคาน้ำมันดิบพุ่งสูงจากความขัดแย้ง แต่หุ้นไทยบางตัว (PTG, PTTGC) กลับติดลบเนื่องจากต้นทุนที่สูงขึ้นและค่าการตลาดที่ถูกควบคุม

**วิกฤตอิหร่าน (Iran Crisis 2025-26)**
"ช่วงวิกฤตอิหร่าน" คือปีทองของหุ้นน้ำมัน หุ้นเกือบทุกตัวเป็นสีเขียวเข้มโดยเฉพาะ PTTEP (สผ.) ของไทยที่มีค่าสูงถึง 2.25 เมื่อเกิดความตึงเครียดในตะวันออกกลางราคาน้ำมันจะพุ่งสูงมาก ใครที่มีธุรกิจขุดเจาะและผลิต (Upstream) อย่าง PTTEP, XOM หรือ CVX จะได้ประโยชน์มหาศาล ความคุ้มค่าในการลงทุนจะพุ่งกระฉูด

**Key Findings:**
- แผนภูมินี้เตือนเราว่า บางครั้งกำไรเยอะแต่ราคาเหวี่ยงเป็นรถไฟเหาะ ก็อาจไม่คุ้มเท่าหุ้นที่กำไรพอดีๆ แต่ราคาเสถียรครับ ดูแค่กำไรไม่ได้ ต้องดู Sharpe Ratio
- ในยามเศรษฐกิจถดถอย (Great Recession) หุ้นพวกนี้จะขาดทุนยับเยิน ดังนั้นหุ้นพลังงานไม่ใช่ที่ปลอดภัยเสมอไป
...
**Key Findings:**
- สินทรัพย์ที่อยู่มุมซ้ายบน (Sweet Spot) ควรได้รับ Overweight ในพอร์ตเนื่องจากมีค่า ผลตอบแทนเทียบความเสี่ยงสูงที่สุดในมุมมองเชิงเปรียบเทียบ
- ขนาดของวงกลม Bubble Size (Sharpe) ช่วยจำแนกระหว่างสินทรัพย์ที่ Return สูงเพราะความเก่งของตัวบริษัทเอง กับที่ Return สูงแต่อาจตามมาพร้อมกับความเสี่ยงเช่นกัน
- แผนที่นี้ไม่คงที่ — ต้อง Re-evaluate อย่างน้อย Quarterly เพื่อปรับ Allocation ตามการเปลี่ยนแปลงของ Regime ของสภาวะตลาดการลงทุน
---
